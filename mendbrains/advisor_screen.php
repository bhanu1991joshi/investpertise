...
<div class="col-md-12">
	...
	<li role="presentation" class="active"><a onClick="showSearch()" href="#founders" aria-controls="founders" role="tab" data-toggle="tab" style="color:#222;">Founders</a></li>
	...
	<li  role="presentation"  class=" tab-1"><a onClick="showSearch()" href="#advisors" aria-controls="advisors" role="tab" data-toggle="tab" >Advisors</a></li>
	</ul>
	...
	<div class="tab-content images-content">
		...
		<div role="tabpanel" class="tab-pane  active" id="founders">
			<div class="col-md-12">
				<div class="col-md-3">
					<img src="founder.png" />
				</div>
